...
public class CryptobatchApplication {

    Logger logger = Logger.getLogger(CryptobatchApplication.class.getSimpleName());

    public static void main(String[] args) {
        SpringApplication.run(CryptobatchApplication.class, args);
    }
